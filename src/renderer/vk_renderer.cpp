...
bool vk_init(VkContext* vkcontext, void* window) 
{
    ...
    appInfo.pApplicationName = "Alone";
    appInfo.pEngineName = "AloneEngine";
    ...
    // Swapchain
    {
        ...
        scInfo.compositeAlpha = VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR; // CAN MESS UP TEXTURES WITH OPAQUE VALUES
